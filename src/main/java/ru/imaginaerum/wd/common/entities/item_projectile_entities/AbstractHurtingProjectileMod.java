...
public class AbstractHurtingProjectileMod extends Projectile {
    ...
    protected AbstractHurtingProjectileMod(EntityType<? extends AbstractHurtingProjectileMod> p_36833_, Level p_36834_) {
        super(p_36833_, p_36834_);
    }

    public AbstractHurtingProjectileMod(EntityType<? extends AbstractHurtingProjectileMod> p_36817_, double p_36818_, double p_36819_, double p_36820_, double p_36821_, double p_36822_, double p_36823_, Level p_36824_) {
    ...
    public AbstractHurtingProjectileMod(EntityType<? extends AbstractHurtingProjectileMod> p_36826_, LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
    ...
    public static void magicalTrail(LevelAccessor world, double x, double y, double z) {
        world.addParticle(ModParticles.ROBIN_STAR_PARTICLES_PROJECTILE.get(), x, y, z, 0, 0, 0);
    }
    public void tick() {
        ...
        if (this.level().isClientSide || (entity == null || !entity.isRemoved()) && this.level().hasChunkAt(this.blockPosition())) {
            super.tick();
            if (this.shouldBurn()) {
                magicalTrail(level(),getX(),getY(),getZ());
            }
...
//            }
            ...
            this.level().addParticle(this.getTrailParticle(), d0, d1 + 0.10, d2, 0.0, 0.0, 0.0);
