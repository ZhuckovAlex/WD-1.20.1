...
public class OpenKingPillagersChest {
    ...
    public static void onRightClickItem(PlayerInteractEvent.RightClickItem event) {
        ...
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            if ((mainHand.getItem() == ItemsWD.GOLDEN_CHEST_KING_PILLAGER.get() && offHand.getItem() == ItemsWD.THE_KING_PILLAGERS_KEY.get()) ||
                    (mainHand.getItem() == ItemsWD.THE_KING_PILLAGERS_KEY.get() && offHand.getItem() == ItemsWD.GOLDEN_CHEST_KING_PILLAGER.get())) {
